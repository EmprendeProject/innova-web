    ...
    <footer className="site-footer" id="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-brand">
          <h3 className="footer-logo">INNOVA <span className="footer-logo-accent">360</span></h3>
          <p className="footer-tagline">
            Expo Congreso Internacional<br />
            Estética y Bienestar 2026
          </p>
          {/* Social icons */}
        ...
        <div className="footer-links-col">
          <h4 className="footer-col-title">ACCESOS</h4>
          <nav className="footer-nav" aria-label="Footer navigation - Accesos">
            <Link to="/" className="footer-link">Inicio</Link>
            <Link to="/entradas" className="footer-link">Entradas</Link>
            <Link to="/stands" className="footer-link">Stands</Link>
          </nav>
        </div>
      ...
      <div className="footer-bottom">
        <p className="footer-copyright">
          © 2026 Innova 360 · Todos los derechos reservados
        </p>
      </div>
    </footer>
  )
